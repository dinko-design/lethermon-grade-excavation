...
import { useCompanySettings } from "@/app/providers/SanityProvider";
    ...
    <div className="min-h-screen flex flex-col antialiased" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <header className="sticky top-0 z-50 bg-[#3D2B1F] border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
          <img src={typeof logo === "string" ? logo : (logo as any).src} alt="Lethermon Grade Excavations" className="h-12 w-auto brightness-0 invert" />
          <a
            href={`tel:${phoneTel}`}
